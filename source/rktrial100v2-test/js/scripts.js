...
function reflowDoc() {
    ...
    if (xmasLights == 'on') {
        xmasDecs = 'img/crDecs/';
        $('.woman').appendTo('#form1').attr('src', 'img/crDecs/woman.png').css('margin', '27px 0px 0px -513px', 'z-index', '1');
        $('img.snowFlakes, img.xmasTree').css('display', 'inline');
        if (winWidth < 767) {
            $('.woman').appendTo('.section1').attr('src', 'img/crDecs/woman.png').css('margin', '11px 0 0 8px', 'z-index', '1');
            $('img.snowFlakes, img.xmasTree, img.mobRaspberrys').css('display', 'none');
            $('img.natural100').css('top', '146px');
        }
    }
    else{
        xmasDecs = 'img/';
    ...
    if (winWidth < 767) {
        ...
        $('li.boost').html('Boost metabolism');
        $('li.feel').html('Get a toned body');
    } else {
        ...
        $('li.boost').html('Boost your metabolism');
        $('li.feel').html('Feel toned &amp; energised');
    }
