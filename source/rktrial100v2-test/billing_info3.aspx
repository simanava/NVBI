<%@ page language="C#" autoeventwireup="true" inherits="BillingInfo3, App_Web_billing_info3.aspx.cdcab7d2" %>
...
<head runat="server">
    ...
    <link href="oldver/css/p2v3.css" rel="stylesheet" type="text/css" />
    ...
    <script src="oldver/js/scriptv3.js" type="text/javascript"></script>
...
<body>
    <div class="wrapMain">
        <table width="400" cellpadding="0" cellspacing="0" border="0" class="product">

            <tr>
                <th width="280" height="80" align="left" class="white">Product</th>
                <th width="58" align="right" class="white">Price</th>
            </tr>
            <tr>
            ...
            <tr>
                <td width="280" height="30">Raspberry Ketone - 30 Day Supply</td>
                <td width="58" align="right">&pound;0.00</td>
            </tr>
            <tr>
                <td width="280" height="30">Postage &amp; Packaging</td>
                <td align="right">&pound;7.95</td>
            </tr>
            <tr>
                <td width="280" height="30">FREE Promo Discount</td>
                <td align="right">-&pound;3.00</td>
            </tr>
            <tr>
                <td width="280" height="40" class="totalWhite">Total</td>
                <td align="right" class="totalGreen" id="p2total">&pound;4.95</td>
            </tr>
        </table>
        <p class="shipmentDetails">
            Shipment estimated time of arrival <span class="raspRed" id="spnShipDate" runat="server">DD September YYYY</span>
        </p>
