...
$(function () {
		...
		$(objField).css('border','1px solid #DDD');
		...
		break
				...
				break
				case"expiry":		if (strUserInput != "") {field = this;isGood(field);$(this).removeClass('error');} else {field = this;isBad(field);$(this).addClass('error');}
				break
...
function openPopUp(linkURL, params) {
window.open(linkURL,'popup', params)
}